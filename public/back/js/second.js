...
$(function(){
   ...
   $('#addBtn').click(function(){
    ...
    /**
     * 注意: 添加分类模态框中有3个隐藏域,每个隐藏域都需要手动设置
     *  (需要手动设置文本,保存id,设置图片地址)
     *  并且,表单校验时,也需要手动设置状态重置
     *  获取表单的实例,并调用updateStatus()方法,手动将表单校验状态重置成 VALID
     *  参数1: 字段名, 参数2: 设置成什么状态, 参数3: 回调(配置提示信息)
     */

    //3.给一级分类菜单注册点击事件(事件委托),让 a 可以被点击
